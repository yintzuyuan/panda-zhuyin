...
const EXAMPLES = [
  { zh:"東", zhVal:[["ㄉ"],["ㄨ"],["ㄥ"]], zhNote:{zh:"",en:""}, twRoma:{zh:"tong（臺羅）",en:"tong (Tâi-lô)"}, tag:{zh:"ong→ㆲ",en:"ong→ㆲ"},
    steps:[
      ...
      {commit:"東", label:{zh:"③ 送出（第一聲免調號）",en:"③ Commit (1st tone, no mark)"}, rule:{zh:"台語的 <b>ong</b> 用一個專用符號 <b>ㆲ</b>，不像華語拼 ㄨ＋ㄥ 兩個符號——方音符號讓韻母收在兩個符號以內。",en:"Taigi writes <b>ong</b> with one dedicated symbol <b>ㆲ</b>, not ㄨ＋ㄥ like Mandarin — phonetic symbols keep each rime within two symbols."}} ]},
  { zh:"無", zhVal:[["ㄨ"],["ˊ","t"]], zhNote:{zh:"",en:""}, twRoma:{zh:"bô（臺羅）",en:"bô (Tâi-lô)"}, tag:{zh:"濁音 ㆠ",en:"voiced ㆠ"},
    steps:[
      ...
      {commit:"無", label:{zh:"④ 送出「無」",en:"④ Commit 無"}, rule:{zh:"<b>ㆠ</b>（b）是濁音聲母，華語沒有這個音；台語的 ㆠㆣㆡ 都是新造的濁音符號。",en:"<b>ㆠ</b> (b) is a voiced onset — absent in Mandarin. Taigi's ㆠㆣㆡ are all newly coined voiced symbols."}} ]},
  { zh:"圓", zhVal:[["ㄩ"],["ㄢ"],["ˊ","t"]], zhNote:{zh:"",en:""}, twRoma:{zh:"înn（臺羅）",en:"înn (Tâi-lô)"}, tag:{zh:"鼻化 ㆪ",en:"nasal ㆪ"},
    steps:[
      ...
      {commit:"圓", label:{zh:"④ 送出「圓」",en:"④ Commit 圓"}, rule:{zh:"<b>ㆪ</b> 是帶鼻音的 i——台語的「鼻化」寫法，符號上畫圈出頭表示，華語完全沒有這一類。",en:"<b>ㆪ</b> is a nasalized i — Taigi's nasalization, marked by a crossed loop on top; Mandarin has no such category."}} ]},
  ...
  { zh:"點", zhVal:[["ㄉ"],["ㄧ"],["ㄢ"],["ˇ","t"]], zhNote:{zh:"",en:""}, twRoma:{zh:"tiám（臺羅）",en:"tiám (Tâi-lô)"}, tag:{zh:"上拉 ㆰ",en:"pull-up ㆰ"},
    steps:[
      ...
      {key:"KT", dir:"down", sym:"ˋ", r:"tone", buf:"ㄉㄧㆰˋ", label:{zh:"④ 下滑＝ˋ 第二聲（同華語四聲手勢）",en:"④ Flick down = ˋ 2nd tone (same gesture as Mandarin 4th)"}},
  ...
  { zh:"對", zhVal:[["ㄉ"],["ㄨ"],["ㄟ"],["ˋ","t"]], zhNote:{zh:"",en:""}, twRoma:{zh:"tuì（臺羅）",en:"tuì (Tâi-lô)"}, tag:{zh:"三調 ˪",en:"3rd tone ˪"},
    steps:[
      ...
      {key:"M1", sym:"ㄧ", r:"medial", buf:"ㄉㄨㄧ", label:{zh:"③ 再點 ㄧ——台語 ㄨㄧ 可相鄰，華語沒有",en:"③ Tap ㄧ again — Taigi allows ㄨㄧ adjacent, Mandarin doesn't"}},
      ...
      {commit:"對", label:{zh:"⑥ 送出「對」（tuì）",en:"⑥ Commit 對 (tuì)"}, rule:{zh:"<b>˪</b>（第三聲）沒有專屬手勢——<b>ˋ 同方向再滑一次</b>就循環變 ˪。華語拼 ㄉㄨㄟˋ、台語拼 ㄉㄨㄧ˪，連韻母都不同。",en:"<b>˪</b> (3rd tone) has no gesture of its own — <b>flick ˋ the same way again</b> to cycle into ˪. Mandarin spells ㄉㄨㄟˋ, Taigi ㄉㄨㄧ˪ — even the rime differs."}} ]},
  { zh:"予", zhVal:[["ㄩ"],["ˇ","t"]], zhNote:{zh:"",en:""}, twRoma:{zh:"hōo（臺羅）",en:"hōo (Tâi-lô)"}, tag:{zh:"七調 ˫",en:"7th tone ˫"},
    steps:[
      ...
      {key:"F1", cell:1, sym:"ㆦ", r:"final", buf:"ㄏㆦ", label:{zh:"② 點 ㆦ＝oo（佔了華語 ㄛ 的位置）",en:"② Tap ㆦ = oo (takes Mandarin ㄛ's spot)"}},
  ...
  { zh:"佮", zhVal:[["ㄍ"],["ㄜ"],["ˊ","t"]], zhNote:{zh:"（華語罕用字）",en:"(rare in Mandarin)"}, twRoma:{zh:"kap（臺羅）",en:"kap (Tâi-lô)"}, tag:{zh:"陰入",en:"4th tone ㆴ"},
    steps:[
      ...
      {commit:"佮", label:{zh:"④ 送出「佮」（kap，「和」）",en:"④ Commit 佮 (kap, 'and')"}, rule:{zh:"入聲尾 <b>ㆴㆵㆻㆷ</b> 是短促收尾，華語沒有。裸寫就是第四聲（陰入），不另外加調號——聲調藏在韻尾裡。",en:"The stop codas <b>ㆴㆵㆻㆷ</b> are abrupt endings absent in Mandarin. Written bare, they are the 4th tone (yin-entering) — no extra mark; the tone lives in the coda."}} ]},
...
/* 聲調資料（調值：教育部通行腔；zh＝華語對應）。#1058：name/markSym/val/gest/zh.name 改 {zh,en}；n/hanzi/glyph/curve/short 維持字串。 */
const TONES = [
  ...
  { n:2, name:{zh:"陰上",en:"Yin-rising"}, hanzi:"黨", glyph:"ㄉㆲˋ",  markSym:{zh:"ˋ",en:"ˋ"},             val:{zh:"51 高降",en:"51 high-falling"}, curve:[5,1], short:false, zh:{name:{zh:"四聲",en:"4th"},curve:[5,1]}, gest:{zh:"聲調鍵往下滑——跟華語四聲同一個動作",en:"Flick the tone key down — same move as Mandarin 4th tone"} },
  ...
  { n:5, name:{zh:"陽平",en:"Yang-level"}, hanzi:"同", glyph:"ㄉㆲˊ",  markSym:{zh:"ˊ",en:"ˊ"},             val:{zh:"24 低升",en:"24 low-rising"}, curve:[2,4], short:false, zh:{name:{zh:"二聲",en:"2nd"},curve:[3,5]}, gest:{zh:"聲調鍵往上滑——跟華語二聲同一個動作",en:"Flick the tone key up — same move as Mandarin 2nd tone"} },
